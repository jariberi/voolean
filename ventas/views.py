...
def afip_aprob(request, pk):
    ...
    if venta.iva105 > Decimal("0"):
        fact.agregarIva(4, "%.2f" % venta.iva105 / Decimal("0.105"), "%.2f" % venta.iva105)
    if venta.iva21 > Decimal("0"):
        fact.agregarIva(5, "%.2f" % venta.iva21 / Decimal("0.21"), "%.2f" % venta.iva21)
    if venta.iva105 > Decimal("0"):
        fact.agregarIva(6, "%.2f" % venta.iva27 / Decimal("0.27"), "%.2f" % venta.iva27)
